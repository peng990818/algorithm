...
<pre>
<strong>输入：</strong>s = ["h","e","left","left","o"]
<strong>输出：</strong>["o","left","left","e","h"]
</pre>
...
<div><div>Related Topics</div><div><li>双指针</li><li>字符串</li></div></div><br><div><li>👍 903</li><li>👎 0</li></div>